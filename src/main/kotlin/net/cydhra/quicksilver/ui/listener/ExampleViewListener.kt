 ...
 * the tooltip.
 *
 * A view listener is registered using [UltralightView.setViewListener].
 *
 * Taken from:
 ...
 */
class ExampleViewListener(private val cursorManager: CursorAdapter) : UltralightViewListener {
    /**
