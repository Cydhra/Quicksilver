 ...
 */
class InputAdapter(private val view: UltralightView) {
     ...
     */
    fun windowContentScaleCallback(window: Long, xScale: Float, yScale: Float) {
        this.xScale = xScale
        this.yScale = yScale
    }
    ...
    fun cursorPosCallback(window: Long, x: Double, y: Double) {
        ...
        } else if (GLFW.glfwGetMouseButton(window, GLFW.GLFW_MOUSE_BUTTON_MIDDLE) == GLFW.GLFW_PRESS) {
